"""
Определение продукта: Вариативные товары

В нашей системе каждый товар считается вариативным товаром.
Вариативные товары объединяют в себе все вариации товара, упрощая весь процесс.
Независимо от того, создаёте ли вы товар без каких-либо указанных опций или определяете до трёх различных опций,
каждая с одним элементом, по сути вы работаете с вариативным товаром.

Варианты товара и опции

Варианты:
Товары могут иметь несколько вариантов, каждый из которых представляет собой уникальную комбинацию атрибутов,
таких как цена, количество на складе и другие характеристики.

Опции:
Товары могут иметь до трёх различных опций. Каждая опция может содержать несколько элементов,
что обеспечивает богатое разнообразие выбора.

Упрощённое управление товарами:

Все операции, связанные с товарами, такие как управление корзиной покупок, обработка заказов и управление складом,
выполняются через варианты товаров. Такой подход повышает эффективность и упрощает обработку товаров на платформе.

При каждом создании товара медиафайлы должны отсутствовать (None), поскольку медиафайлы будут прикрепляться к товару
после его создания.
