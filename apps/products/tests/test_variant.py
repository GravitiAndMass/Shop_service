...
class TestRetrieveVariants(VariantTestBase):
    """
    Тестирует получение варианта товара в многовариантном сценарии.
    """
    ...
    def test_list_product_variants(self):
        """
        Тестирует получение варианта товара.
        """
...
class TestUpdateVariants(VariantTestBase):
    """
    Тестирует обновление варианта товара в многовариантном сценарии.
    """
    ...
    def test_update_variant(self, payload):
        """
        Тестирует обновление варианта товара, обновляя только те поля, которые присутствуют в теле запроса, и оставляя остальные поля без изменений.
        """
