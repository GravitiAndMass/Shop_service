...
class ProductService:
    ...
    def __create_product_options(cls):
        """
            Создаёт новую опцию, если она не существует, и обновляет её элементы,
            а также гарантирует, что опции уникальны для каждого товара и элементы в каждой опции уникальны.
        """
    ...
    def create_media(cls, product_id, alt, files):
        """
        Сохраняет загруженные медиафайлы в каталог media и прикрепляет загрузки к товару.
        """
    ...
    def retrieve_media_list(cls, product_id):
        """
        Получить все медиафайлы товара.
        """
    ...
    def retrieve_single_media(cls, media_id):
        """
        Получить медиафайл по его идентификатору.
        """
